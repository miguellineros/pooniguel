...
class Vuelo(Localidad, Avion):
    def __init__(self, id_vuelo, fecha_hora_salida, destino, origen, cod_vuelo, id_avion, tipo_vuelo, id_localidad=0):
        Localidad.__init__(self, id_localidad, '', 0.0, 0.0)
        Avion.__init__(self, id_avion)
